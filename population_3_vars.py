...
from op_node_3_vars import OpNode
from symbol_tree_3_vars import SymbolTree
...
class Population():
    ...
    def __init__(self, size, depth_limit, terminal_bound, rep, mutate, x, y, z, f):
        '''
        ...
        Parameters:
            ...
            z - The z-values of the function you're evaluating
            f - The f-values of the function you're evaluating
        '''
    ...
    def new_tree(self, cutoff):
        ...
        t.calc_error(self.x_vals, self.y_vals, self.z_vals, self.f_vals)
        return t
    ...
    def next_gen(self):
        ...
        while len(new_gen) < self.size:
            ...
            copy1.calc_error(self.x_vals, self.y_vals, self.z_vals, self.f_vals)
