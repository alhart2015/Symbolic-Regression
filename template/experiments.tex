...
\label{sec:expts}
	...
	To perform Symbolic Regression with GP on the
        ...
        the operations ‚Äì and exponentiation. We were able to do so
	...
	Once the initial population was generated, we applied the
        ...
        tree'Äôs evaluation of a given x and the actual value, f(x). We
	...
	We used three different methods to generate a new
        ...
        depth limit, where we defined "Äútoo deep"Äù as deeper than the
